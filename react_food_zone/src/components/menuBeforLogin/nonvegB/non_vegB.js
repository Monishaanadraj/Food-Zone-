...
import style from "./nonVeg.module.css"
...
const Viewfood = () => {
  ...
  useEffect((category) => {
    ...
    axios.get(`http://localhost:3001/user/getNonvegFood/'${category}'`, inpobj)
      .then(response => {
  ...
  return (
    <>
      ...
      <div className={style.nav_button}>
        ...
        <NavLink className={style.nav_btn} to="/desB">DESSERTS</NavLink>
